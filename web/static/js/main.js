...
var _user$project$Main$postFavData = F2(
	function (name, id) {
...
var _user$project$Main$webinit = {webname: '', webid: 0};
...
var _user$project$Main$Favorite = F2(
	function (a, b) {
		return {webname: a, webid: b};
	});
var _user$project$Main$sendData = A3(
	_elm_lang$core$Json_Decode$map2,
	_user$project$Main$Favorite,
	A2(_elm_lang$core$Json_Decode$field, 'name', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'webid', _elm_lang$core$Json_Decode$int));
var _user$project$Main$postData = F2(
	function (name, id) {
		return A3(
			_elm_lang$http$Http$post,
			_user$project$Main$favoriteapi,
			_elm_lang$http$Http$jsonBody(
				A2(_user$project$Main$postFavData, name, id)),
...
var _user$project$Main$PostData = F2(
	function (a, b) {
		return {ctor: 'PostData', _0: a, _1: b};
	});
									...
									_0: A2(
										_elm_lang$html$Html$button,
										{
											...
											_0: _elm_lang$html$Html_Events$onClick(
												A2(_user$project$Main$PostData, n.username, n.userid)),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
			...
			case 'PostData':
				return {
					...
					_1: A2(
						...
						A2(_user$project$Main$postData, _p0._0, _p0._1))
				};
			case 'DataPosted':
				if (_p0._0.ctor === 'Ok') {
					return {
